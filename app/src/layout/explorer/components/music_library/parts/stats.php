    ...
    <div class='subContent' data-cat="STATS">
        <div class='statsWrapper'>
            <div id='stats'>
                ...
                <div class='statsPh' id='statsArtists' data-phid='1' data-def="<?= ContextManager::get("i18n")("artists") ?>"></div>
            </div>
            <div id='statsSwitcher'>
                ...
                <div>
                    <label class="clickable" title='<?= ContextManager::get("i18n")("artists") ?>'>
                        <input id='rArtists' data-phid='1' type='radio' name='statsS' onchange="switchPanel(event)" autocomplete="off">
                        <i class="fas fa-users"></i>
                        <span><?= ContextManager::get("i18n")("artists") ?></span>
                    </label>
                </div>
            </div>
        </div>
